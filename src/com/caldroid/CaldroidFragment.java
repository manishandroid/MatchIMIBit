...
public class CaldroidFragment extends DialogFragment {
	...
	public final static String _POINT_COLOR_FOR_DATETIME_MAP = "_pointColorForDateTimeMap";
	...
	/**
	 * pointColorForDateMap holds color for text for each date
	 */
	protected HashMap<DateTime, Integer> pointColorForDateTimeMap = new HashMap<DateTime, Integer>();
	...
	public HashMap<String, Object> getCaldroidData() {
		...
		caldroidData.put(_POINT_COLOR_FOR_DATETIME_MAP, pointColorForDateTimeMap);
	 ...
	 * @return
	 */
	public void setPointColorForDates(HashMap<Date, Integer> textColorForDateMap) {
		// Clear first
		pointColorForDateTimeMap.clear();
		...
		for (Date date : textColorForDateMap.keySet()) {
			Integer resource = textColorForDateMap.get(date);
			DateTime dateTime = CalendarHelper.convertDateToDateTime(date);
			pointColorForDateTimeMap.put(dateTime, resource);
		}
	}

	public void setPointColorForDateTimes(
			HashMap<DateTime, Integer> pointColorForDateTimeMap) {
		this.pointColorForDateTimeMap.putAll(pointColorForDateTimeMap);
	}

	public void setPointColorForDate(int pointColorRes, Date date) {
		DateTime dateTime = CalendarHelper.convertDateToDateTime(date);
		pointColorForDateTimeMap.put(dateTime, Integer.valueOf(pointColorRes));
	}
	
	public void setPointColorForDateTime(int pointColorRes, DateTime dateTime) {
		pointColorForDateTimeMap.put(dateTime, Integer.valueOf(pointColorRes));
	}
	...
	public void refreshView() {
		Log.d(CommonUtilities.TAG, "Refresh " + month + " " + year);
		
		if(year > 0 && month > 0) {
			// Refresh title view
			monthTitleTextView.setText(toTitleCase(new DateTime(year, month, 1, 0, 0, 0, 0).monthOfYear().getAsText()
					+ " " + year));
...
//		setRetainInstance(true);
	...
	public class DatePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			Log.d(TAG, String.format("Position Page Selected %d", position));
		}
